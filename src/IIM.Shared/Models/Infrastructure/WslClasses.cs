...
namespace IIM.Shared.Models
{
    ...
    public sealed class HealthCheckResult
    {
        ...
        public InferencePipelineStats Stats { get; set; }
    }
    ...
    /// <summary>
    /// Request to ensure WSL is setup
    /// </summary>
    public record EnsureWslRequest(
        int? TimeoutSeconds,
        bool? ForceReinstall);

    /// <summary>
    /// Request to execute command in WSL
    /// </summary>
    public record ExecuteWslCommandRequest(
        string Command,
        string? DistroName);

    /// <summary>
    /// Request to copy file to WSL
    /// </summary>
    public record CopyFileToWslRequest(
        string WindowsPath,
        string WslPath);

    /// <summary>
    /// Request to copy file from WSL
    /// </summary>
    public record CopyFileFromWslRequest(
        string WslPath,
        string WindowsPath);
