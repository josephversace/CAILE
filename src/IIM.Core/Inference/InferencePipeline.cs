...
namespace IIM.Core.Inference
{
    ...
    public sealed class InferencePipeline : IInferencePipeline, IDisposable
    {
        ...
        private readonly IModelOrchestrator _orchestrator;  // This will use IIM.Core.Inference.IModelOrchestrator
        ...
        private async Task ProcessSingleRequestAsync(QueuedRequest request, CancellationToken ct)
        {
            ...
            try
            {
                ...
                // IMPORTANT: The IModelOrchestrator from IIM.Core.Inference namespace has InferAsync
