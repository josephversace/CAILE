...
namespace IIM.Application.Models
{
    ...
    public class ModelManagementService : IModelManagementService
    {
        ...
        public ModelManagementService(IModelOrchestrator modelOrchestrator, ILogger<ModelManagementService> logger, IModelRepository model  )
        {
        ...
        public async Task<bool> LoadModelAsync(string modelId, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                // Create properly initialized ModelLoadRequest with all required fields
        ...
        public async Task<bool> UnloadModelAsync(string modelId, CancellationToken cancellationToken = default)
        {
            try
            {
                 await _modelOrchestrator.UnloadModelAsync(modelId, cancellationToken);
